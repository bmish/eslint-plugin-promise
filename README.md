...
| [named](docs/rules/named.md)                                           | Ensure named imports correspond to a named export in the remote file.                | ❗ ☑️ <code>⌨️</code><sup><code>🚫</code></sup> |    |    |    |
...
| [no-duplicates](docs/rules/no-duplicates.md)                                     | Forbid repeated import of the same module in multiple places.              | <code>☑️</code><sup><code>⚠️</code></sup> <code>🚸</code><sup><code>⚠️</code></sup> | 🔧 |    |    |
