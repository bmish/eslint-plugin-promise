...
| [named](docs/rules/named.md)                                           | Ensure named imports correspond to a named export in the remote file.                | ❗ ☑️ <span nowrap>⌨️<sup>🚫</sup></span> |    |    |    |
...
| [no-duplicates](docs/rules/no-duplicates.md)                                     | Forbid repeated import of the same module in multiple places.              | <span nowrap>☑️<sup>⚠️</sup></span> <span nowrap>🚸<sup>⚠️</sup></span> | 🔧 |    |    |
