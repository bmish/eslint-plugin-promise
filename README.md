...
| [no-named-as-default](docs/rules/no-named-as-default.md)               | Forbid use of exported name as identifier of default export.                          | <span style="white-space:nowrap">☑️<sup>⚠️</sup></span> ⚠️ |    |    |    |
| [no-named-as-default-member](docs/rules/no-named-as-default-member.md) | Forbid use of exported name as property of default export.                            | <span style="white-space:nowrap">☑️<sup>⚠️</sup></span> ⚠️ |    |    |    |
...
| [named](docs/rules/named.md)                                           | Ensure named imports correspond to a named export in the remote file.                | ❗ ☑️ <span style="white-space:nowrap">⌨️<sup>🚫</sup></span> |    |    |    |
...
| [no-duplicates](docs/rules/no-duplicates.md)                                     | Forbid repeated import of the same module in multiple places.              | <span style="white-space:nowrap">☑️<sup>⚠️</sup></span> ⚠️ | 🔧 |    |    |
